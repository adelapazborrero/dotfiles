# Generated by Powerlevel10k configuration wizard on 2022-07-19 at 18:40 CEST.
...
# round separators, round heads, round tails, 2 lines, disconnected, full frame,
# darkest-ornaments, sparse, many icons, concise, instant_prompt=off.
...
() {
  ...
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND='#ebcb8b'
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND='#525a6c'
  # Default current directory foreground color.
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=254
  # If directory is too long, shorten some of its segments to the shortest possible unique
  # prefix. The shortened directory can be tab-completed to the original.
  # typeset -g POWERLEVEL9K_SHORTEN_STRATEGY=truncate_to_unique
  typeset -g POWERLEVEL9K_SHORTEN_STRATEGY=tab-completed
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
      ...
      # '*test*'  TEST    # to match your needs. Customize them as needed.
      '*'       DEFAULT)
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_FOREGROUND=8
  ...
  # Google cloud color.
  typeset -g POWERLEVEL9K_GCLOUD_FOREGROUND=8
